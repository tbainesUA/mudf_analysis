...
def measure_stack(input_stack, input_masterlist, output_meas, output_fig, zmax = 2.3, showfig = False, twocomp=True):
   ...
   # oii_ew_err =  oii_ew* np.sqrt( (out2.perror[13]/out2.params[13])**2 + (out2.perror[0]/out2.params[0])**2 + (out2.perror[4]/out2.params[4])**2 + covar_term)
    ...
    #M.D.R# ew_oiii_rest = dat['EW_oiii_obs'] #M.D.R#
    flam_oiii = dat['flam_oiii']
    #M.D.R# flam_oiii = dat['foiii']     #M.D.R#
    flam_ha = dat['flam_ha']
    #M.D.R# flam_ha = dat['fhanii']     #M.D.R#
    flam_hb = dat['flam_hb']
    #M.D.R# flam_hb = dat['fhb']     #M.D.R#
    flam_hg = dat['flam_hg']
    #flam_hg = dat['fhg']     #M.D.R#
    flam_hd = dat['flam_hd']
    #flam_hd = dat['fhd']     #M.D.R#
#M.D.R# Field ID logM z foiii eoiii EW_oiii_obs fhb ehb fhanii ehanii fsii esii foii eoii MeX_AGN Xray IR_AGN
    #M.D.R# TEMPORARY FIX AS HG AND HD NEED TO BE REDDENED VALUES READ-IN PROPRERLY.#M.D.R#
    #M.D.R# flam_hg = dat['fhb']*0.468    #M.D.R#
    #M.D.R# flam_hd = dat['fhb']*0.259    #M.D.R#
    #M.D.R# TEMPORARY FIX AS HG AND HD NEED TO BE REDDENED VALUES READ-IN PROPRERLY.#M.D.R#
